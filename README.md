# com-chilipeppr-workspace-kyjak
A Kyjak's Workspace.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Kyjak
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-kyjak |
| Name                  | Workspace / Kyjak |
| Description           | A Kyjak's Workspace. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/kyjak/Kyjak-s-ChilliPeppr-Workspace/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/mkrsjak/cnc |
| Github URL            | http://github.com/kyjak/Kyjak-s-ChilliPeppr-Workspace |
| Test URL              | https://preview.c9users.io/mkrsjak/cnc/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/kyjak/Kyjak-s-ChilliPeppr-Workspace/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-kyjak"], // the id you gave your workspace
      function(myWorkspaceKyjak) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Kyjak just got loaded.", myWorkspaceKyjak);
        myWorkspaceKyjak.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-kyjak"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Kyjak"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A Kyjak's Workspace."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/kyjak/Kyjak-s-ChilliPeppr-Workspace/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/mkrsjak/cnc"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/kyjak/Kyjak-s-ChilliPeppr-Workspace"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://cnc-mkrsjak.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
