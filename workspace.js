...
cprequire_test(["inline:com-chilipeppr-workspace-kyjak"], function(ws) {
    ...
    $('title').html("Kyjak's Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-kyjak", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-kyjak", // Make the id the same as the cpdefine id
        name: "Workspace / Kyjak", // The descriptive name of your widget.
        desc: `A Kyjak's Workspace.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a kyjak
